...
def excel_formatter(json_file_name, excel_file_name, group, annotation_dict):
    ...
    format_ambiguous = writer_book.add_format({'font_color': '#C70039', 'bg_color': '#E2CFDD'})
    ...
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'S', 'format': format_ambiguous})
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'Y', 'format': format_ambiguous})
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'R', 'format': format_ambiguous})
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'W', 'format': format_ambiguous})
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'K', 'format': format_ambiguous})
    ws.conditional_format(2, 1, rows - 2, cols, {'type': 'text', 'criteria': 'containing', 'value': 'M', 'format': format_ambiguous})
...
def preprocess_tables(task_queue, annotation_dict, timeout):
    while True:
        ...
        for column_header in tree_order_df:
            ...
            # Starting row number with longest continuous SNPs in column
